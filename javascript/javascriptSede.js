$(document).ready(function () {
    ...
    function manageRow(data) {
        ...
        $.each(data, function (key, value) {
            rows = rows + '<tr>';
            rows = rows + '<td>' + value.cod_sede + '</td>';
    ...
    function createForm() {
        ...
        html = html + '<label class="control-label" for="cod_emp">Empresa</label>';
        html = html + '<input type="text" name="cod_emp" class="form-control" data-error="Por favor, insira o código de empresa." required />';
        html = html + '<div class="help-block with-errors"></div>';
        html = html + '</div>';
        html = html + '<label class="control-label" for="cod_local">Local</label>';
        html = html + '<input type="text" name="cod_local" class="form-control" data-error="Por favor, insira o código de local." required />';
        html = html + '<div class="help-block with-errors"></div>';
        html = html + '</div>';
    ...
    function createEditForm() {
        ...
        html = html + '<div class="form-group">';
        html = html + '<label class="control-label" for="cod_sede">Código</label>';
        html = html + '<input type="text" name="cod_sede" class="form-control" data-error="Por favor, insira o código de sede." required />';
        html = html + '<div class="help-block with-errors"></div>';
        html = html + '</div>';
        html = html + '<label class="control-label" for="cod_emp">Empresa</label>';
        html = html + '<input type="text" name="cod_emp" class="form-control" data-error="Por favor, insira o código de empresa." required />';
    ...
    function createViewForm() {
        ...
        html = html + '<div class="form-group">';
        html = html + '<label class="control-label" for="cod_sede">Código</label>';
        html = html + '<input type="text" name="cod_sede" class="form-control" readonly/>';
        html = html + '</div>';
        html = html + '<div class="form-group">';
        html = html + '<label class="control-label" for="cod_emp">Empresa</label>';
    ...
    $(".crud-submit").click(function (e) {
        ...
        var cod_sede = $("#create-item").find("input[name='cod_sede']").val();
        ...
        $.ajax({
            ...
            type: 'POST',
            url: form_action,
            data: {cod_sede: cod_sede, cod_emp: cod_emp, cod_local: cod_local}
        }).done(function (data) {

            $("#create-item").find("input[name='cod_sede']").val('');
    ...
    $("body").on("click", ".edit-item", function () {
        ...
        var cod_sede = dataCon[index].cod_sede;
        var cod_emp = dataCon[index].cod_emp;
        var cod_local = dataCon[index].cod_local;

        $("#edit-item").find("input[name='cod_sede']").val(cod_sede);
    ...
    $("body").on("click", ".view-item", function () {
        ...
        $("#view-item").find("input[name='cod_sede']").val(cod_sede);
    ...
    $(".crud-submit-edit").click(function (e) {
        ...
        var cod_sede = $("#edit-item").find("input[name='cod_sede']").val();
